...
class Toast {
  static init() {
    this.showDuration = 2.5; // create (new) container element with id set to 'toasts' 
...
class Auth {
  ...
  async signIn(userData) {
    ...
    _Router.default.init(); // REDIRECT USER
  ...
  async check(success) {
    ...
    this.currentUser = data.user; // run success function
...
class Utils {
  ...
  } // runs in the init() function - after the page is rendered
  // finds the pageContent div on the page
  // fromTo = fade in (gsap) animation
...
class UserAPI {
  ...
  async updateUser(userId, userData) {
    ...
    let responseHeader; // Fetch 1 - FORM DATA
...
exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/welcome.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"ListingAPI.js":[function(require,module,exports) {
"use strict";
...
class ListingAPI {
  ...
  async getListings() {
    ...
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/listing"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
  ...
  async getListing(id) {
    // go to the /listing route (backend API)
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/listing/").concat(id), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
class ExploreView {
  ...
  async filterListings(field, match) {
    ...
    this.listings = await _ListingAPI.default.getListings();
  ...
  handleFilterBtn(e) {
    ...
    console.log("target button = ", e.target); // clear all filter buttons active state

    this.clearFilterBtns(); // add new attribute (active state) to target button

    e.target.setAttribute("type", "primary"); // get the match and field (from button) to filter listings with
  ...
  */
  ...
  async getListings() {
    try {
      ...
      this.listings = await _ListingAPI.default.getListings();
      console.log(this.listings); // re-render page to render listings brought in by getListings()
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../ListingAPI":"ListingAPI.js","../../Toast":"Toast.js"}],"views/pages/teachersLounge.js":[function(require,module,exports) {
"use strict";
...
var _default = new TeachersLoungeView();
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js"}],"views/pages/listing.js":[function(require,module,exports) {
"use strict";
...
class listingView {
  ...
  async getListing() {
    ...
    console.log(id); // get the listing (API request) based on the id passed in
    // and fill the listing container (this.listing - set to null in init())

    this.listing = await _ListingAPI.default.getListing(id);
  ...
  contactHandler() {
    ...
    document.body.append(dialogEl); // show sl-dialog (dialogs hidden by default)
...
var _default = new listingView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../ListingAPI":"ListingAPI.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
},{}],"views/pages/myAccount.js":[function(require,module,exports) {
"use strict";
...
var _default = new MyAccountView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","moment":"../node_modules/moment/moment.js"}],"views/pages/myListing.js":[function(require,module,exports) {
"use strict";
...
var _default = new MyListingView();
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/newListing.js":[function(require,module,exports) {
"use strict";
...
class newListingView {
  ...
  async newListingSubmitHandler(e) {
    ...
    e.preventDefault(); // add loading animation to submit button with loading attribute

    const submitBtn = document.querySelector('.submit-btn');
    submitBtn.setAttribute('loading', ''); // grab the form data (from inside the event object), store in formData

    const formData = e.detail.formData; // send form data to ListingAPI:

    /* call the newListing method from the ListingAPI
    - wrap in a try/catch (takes time to complete) + use async/await (promise) */

    try {
      await _ListingAPI.default.newListing(formData);

      _Toast.default.show('Listing added');
      ...
      if (radioInputs) radioInputs.forEach(radioInput => radioInput.removeAttribute('checked')); // reset file input (photo/image upload area)

      const fileInput = document.querySelector('input[type=file]');
      if (fileInput) fileInput.value = null;
    } catch (err) {
      // if something goes wrong (with newListing) show method
      _Toast.default.show(err, 'error');
...
var _default = new newListingView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../ListingAPI":"ListingAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _teachersLounge = _interopRequireDefault(require("./views/pages/teachersLounge"));

var _favourites = _interopRequireDefault(require("./views/pages/favourites"));

var _listing = _interopRequireDefault(require("./views/pages/listing"));
...
var _myAccount = _interopRequireDefault(require("./views/pages/myAccount"));

var _myListing = _interopRequireDefault(require("./views/pages/myListing"));

var _editProfile = _interopRequireDefault(require("./views/pages/editProfile"));

var _newListing = _interopRequireDefault(require("./views/pages/newListing"));
...
const routes = {
  ...
  '/myListing': _myListing.default,
  '/editProfile': _editProfile.default,
  '/newListing': _newListing.default
};
...
var _default = AppRouter; // Named exports ---------------------------------------
...
class App {
  ...
  init() {
    ...
    _Toast.default.init(); // AuUTHENTICATION CHECK - run the Auth.js check() function 
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject4()), this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject5(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject6()), _Router.anchorRoute, e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/myAccount'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject7(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject8()), _Router.anchorRoute, this.menuClick, () => _Auth.default.signOut());
  } // end render()


}); // end AppHeader class
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-listing-card.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-listing-card', class Listing extends _litElement.LitElement {
  constructor() {
    super();
  ...
  viewListingHandler() {
    (0, _Router.gotoRoute)("/listing?id=".concat(this.id));
  } // called when add to favourties heart button/icon is clicked
  ...
  async addFavHandler() {
    try {
      await _UserAPI.default.addFavListing(this.id);

      _Toast.default.show('Listing added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
...
require("./components/va-listing-card");
...
*/
// bring in the App object exported in the App.js file
// components (custom web components) ------------
// these components are now accessible in any page view
// top menu and slide out menu (main)
// creates card for each listing result on Explore view
// styles ----------------------------------------
